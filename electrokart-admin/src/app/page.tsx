...
const testimonials = [
  {
    name: 'Sandesh Gharti',
    comment:
      "Electrokart has revolutionized how I shop for tech. It's so convenient!",
  },
  {
    name: 'Jane Doe',
    comment:
  ...
  return (
    <div className='min-h-screen'>
      <header className='container mx-auto px-4 py-6 flex justify-between items-center'>
        <h1 className='text-2xl font-bold'>Electrokart</h1>
      </header>
                ...
                <Card>
                  <CardContent className='p-6'>
                    <div className='flex items-center mb-4'>
                      <Image
                        src={`https://www.facebook.com/share/1BAHmS81Cz/?mibextid=xfxF2i`}
      ...
      <footer className='bg-[#1BC464] text-white'>
        <Link
          href={`https://www.linkedin.com/in/prabhat-poudel-b157b81ab?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app`}
          target='_blank'
